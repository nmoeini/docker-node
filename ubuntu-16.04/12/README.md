...
FROM nmoeini/node:12-xenial-20200706
...
services:
  node:
    image: "nmoeini/node:12-xenial-20200706"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app nmoeini/node:12-xenial-20200706 node your-daemon-or-script.js
```
