...
FROM nmoeini/node:14-xenial-20200807
...
services:
  node:
    image: "nmoeini/node:14-xenial-20200807"
    user: "node"
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app -w /usr/src/app nmoeini/node:14-xenial-20200807 node your-daemon-or-script.js
```
